                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: [
                        ...
                        AppTheme.amethyst.withAlpha(40),
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            gradient: RadialGradient(
                              colors: [
                                AppTheme.dustyRose.withAlpha(20),
                                Colors.transparent,
                              ],
                            ),
                          ),
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                           ...
                           try {
                             ...
                             if (context.mounted) {
                               ScaffoldMessenger.of(context).showSnackBar(
                                 SnackBar(content: Text('Could not open reel: $e')),
                               );
                             }
                           }
                        },
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: AppTheme.amethyst, // Primary brand color
                          foregroundColor: AppTheme.cream,
                          elevation: 8,
                          shadowColor: AppTheme.amethyst.withAlpha(100),
                    ...
                    if (reel.keyFacts.isNotEmpty) ...[
                      _buildSection(
                        ...
                        iconColor: const Color(0xFFD4B86A),
                        title: 'Key Facts',
                        child: Column(
                    ...
                    if (reel.peopleMentioned.isNotEmpty) ...[
                      _buildSection(
                        ...
                        iconColor: const Color(0xFFCF6B8E),
                    ...
                    if (reel.actionableItems.isNotEmpty) ...[
                      _buildSection(
                        ...
                        iconColor: const Color(0xFF7DC4A5),
                        title: 'Action Items',
                        child: Column(
