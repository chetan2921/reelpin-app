...
import 'package:reelpin/features/collections/presentation/share_collection_sheet.dart';
...
class _CollectionDetailScreenState extends ConsumerState<CollectionDetailScreen> {
  ...
  Future<void> _loadShared() async {
    ...
    try {
      final detail =
          await ref.read(collectionsApiProvider).getSharedCollection(widget.sharedToken!);
